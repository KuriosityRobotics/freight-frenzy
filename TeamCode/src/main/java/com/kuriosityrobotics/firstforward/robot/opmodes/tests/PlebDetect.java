...
public class PlebDetect extends LinearOpMode {
    ...
    public void runOpMode() {
        var detector = new CargoDetectorConsumer(PoseProvider.of(Pose.ZERO, Pose.ZERO), PhysicalCamera.of(new Vector3D(0, 12.5, 0), new Rotation(new Vector3D(-1, 0, 0), PI/6)));
