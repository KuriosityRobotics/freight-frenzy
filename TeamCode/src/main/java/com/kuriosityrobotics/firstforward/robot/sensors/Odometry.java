...
public class Odometry implements Telemeter {
    ...
    // global pos of robot, can be changed through constructor
    ...
    public ArrayList<String> getTelemetryData() {
        ...
        data.add("worldHeading (Rad): " + (worldHeadingRad));
        data.add("worldHeading (Deg): " + Math.toDegrees(angleWrap(worldHeadingRad)));
