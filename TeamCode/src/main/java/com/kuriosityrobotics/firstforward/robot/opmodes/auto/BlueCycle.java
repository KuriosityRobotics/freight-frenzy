...
public class BlueCycle extends LinearOpMode {
    ...
    public static final Pose BLUE_BETWEEN_WOBBLE_WALLGAP = Pose.fieldMirror(6.5, 62.5, Math.toRadians(180));
    public static final Pose BLUE_WALL_GAP = Pose.fieldMirror(6.5, 46.5, Math.toRadians(180));
