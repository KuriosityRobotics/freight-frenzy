...
public class BlueCarousel extends LinearOpMode {
    ...
    public static final Pose WOBBLE = Pose.fieldMirror(28, 100, Math.toRadians(-50));
    ...
    public static final Pose PARK = Pose.fieldMirror(33, 5 * 23.5 + 12, Math.toRadians(-90));
    ...
    public void runOpMode() {
        ...
        if (detected == OuttakeModule.VerticalSlideLevel.DOWN_NO_EXTEND) {
            ...
            toWobble = new PurePursuit(new WayPoint[]{
                    new WayPoint(START, new VelocityLock(10, false), robot.outtakeModule.extendOuttakeAction(OuttakeModule.VerticalSlideLevel.DOWN, OuttakeModule.TurretPosition.STRAIGHT)),
