...
import com.kuriosityrobotics.firstforward.robot.sensors.LocalizeKalmanFilter;
...
public class WebcamLocalization {
    private Robot robot;
    ManagedCamera vuMarkCam = new ManagedCamera("Webcam 1", robot.hardwareMap, new VuforiaConsumer() {
        ...
        public void setup(VuforiaLocalizer vuforia) {
            ...
            LocalizeKalmanFilter kalmanFilter = new LocalizeKalmanFilter(robot, (RealMatrix) this.robotCoordinatesWebcam);
    ...
    }, frame -> RobotLog.v("LocalizationProvider", String.valueOf(frame.width())));
}